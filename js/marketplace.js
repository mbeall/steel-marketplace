...
function newView(attachment) {
  jQuery("#product_view").append('<div class="product-view" id="'+attachment.id+'"><div class="product-view-controls"><span id="controls_'+attachment.id+'">'+attachment.title+'</span><a class="del-product-view" href="#" onclick="deleteView(\''+attachment.id+'\')" title="Delete product view"><span class="dashicons dashicons-dismiss" style="float:right"></span></a></div><img id="product_view_img_'+attachment.id+'" src="'+attachment.url+'" style="width:250px;height:155px;"><div style="clear:both;"></div><span class="dashicons dashicons-format-image" style="float:left;padding:5px;"></span><input class="product-view-title" type="text" size="20" name="product_view_title_'+attachment.id+'" id="product_view_title_'+attachment.id+'" value="'+attachment.title+'" placeholder="Title (i.e. Front)" /></div>');
